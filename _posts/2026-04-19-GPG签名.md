...
随后我又想了解一下GPG对commit签名，它能证明你是你。由于Git去中心化设计，理论上来说任何人都可以伪造你的身份。

下面我以macOS系统为例介绍一下GPG签名过程。
...
![生成](https://g.565455.xyz/statics/assets/gpg-0.png)

![上传](https://g.565455.xyz/statics/assets/gpg-1.png)
